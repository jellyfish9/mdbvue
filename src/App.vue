    ...
    <mdb-navbar dark position="top" class="default-color" scrolling :scrollingOffset="20">
      ...
      <mdb-navbar-toggler>
        <mdb-navbar-nav right>
          <mdb-nav-item exact to="/" waves-fixed>首页</mdb-nav-item>
          <mdb-nav-item to="/css" waves-fixed>CSS</mdb-nav-item>
          <mdb-nav-item to="/components" waves-fixed>组件</mdb-nav-item>
          <mdb-nav-item to="/advanced" waves-fixed>高级</mdb-nav-item>
          <mdb-nav-item to="/navigation" waves-fixed>导航</mdb-nav-item>
          <mdb-nav-item to="/forms" waves-fixed>表单</mdb-nav-item>
          <mdb-nav-item to="/tables" waves-fixed>表格</mdb-nav-item>
          <mdb-nav-item to="/modals" waves-fixed>对话框</mdb-nav-item>
          <mdb-nav-item to="/plugins" waves-fixed>插件</mdb-nav-item>
        </mdb-navbar-nav>
      </mdb-navbar-toggler>
    </mdb-navbar>
